...
from model.error import Error as M_Error
try:
...
class Result:
    ...
    def __init__(self, vue, model):
        ...
        self.vue = vue
        self.model = model
        self.model.my_result.add_callback(self.param_change_result)
        self.m_error.my_error.add_callback(self.param_change_error)
    ...
    def param_change_result(self, liste):
        """
        Check parameters list change
        """
        self.vue.set_result(liste)

    def param_change_error(self, liste):
        """
        Check parameters list change
        """
        self.vue.set_error(liste)
